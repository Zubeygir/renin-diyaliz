...
| Kurumsal + istatistik | Count-up animasyonu motion bütçesini karşılıyor, ek reveal yok |
| Hizmetler kartları | **Stagger**: kartlar aynı anda değil ~80-120ms aralıklarla art arda belirir (liste olduğu için meşru — bkz. aşağıda) |
| Servis ağı haritası | Zaten işlevsel animasyonlu (bölgeleri vurgulayan hareket), ek reveal yok |
| Anlaşmalı kurumlar (swiper) | Swiper'ın kendi hareketi yeterli, girişte sade fade |
| Son yazılar | Hizmetler gibi kart listesi — aynı stagger mantığı |
| İletişim CTA | Sade, hareketsiz — kapanış bloğu |
