        ...
        {services && services.length > 0 ? (
          ...
          <FadeIn>
            <p className="text-muted-foreground text-center py-16">
              {locale === "en" ? "No services found." : "Henüz eklenmiş bir hizmet bulunmuyor."}
            </p>
          </FadeIn>
        )}
        ...
        {pageData?.ctaLabel && pageData?.ctaLink && (
          <FadeIn className="mt-16 md:mt-24 p-8 md:p-12 rounded-2xl bg-gradient-to-r from-primary/10 via-primary/5 to-background border text-center max-w-4xl mx-auto">
            <h3 className="text-2xl md:text-3xl font-bold mb-4">
              {locale === "en" ? "Looking for More Information?" : "Daha Fazla Bilgi mi İstiyorsunuz?"}
            </h3>
            <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
              {locale === "en"
                ? "Contact us now to find the most suitable solution and receive professional care."
