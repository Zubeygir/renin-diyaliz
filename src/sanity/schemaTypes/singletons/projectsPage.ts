...
export const projectsPageType = defineType({
  ...
  fields: [
    ...
    defineField({ name: "ctaLabel", title: "CTA Buton Metni", type: "localizedString", group: "content" }),
    defineField({ name: "ctaLink", title: "CTA Buton Linki", type: "localizedString", group: "content" }),
    // SEO Group
